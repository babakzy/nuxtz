<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="prose max-w-none">
      ...
      <section class="mb-6">
        <h2 class="text-2xl font-semibold mb-3">1. Terms</h2>
        <p>
          By accessing and using this website, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to abide by these terms, please do not use this website. The terms and conditions set out herein are subject to change without notice.
        </p>
      </section>
